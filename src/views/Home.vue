    ...
    export default {
        ...
        data() {
            return {
                ...
                vegetables: false,
                warning: false,
                base: ['pomodoro_e_mozzarella', 'bianca', 'rossa'],
                listaVerdure: ['cipolle', 'peperoni', 'melanzane', 'zucchine', 'carciofi', 'olive', 'olive_verdi', 'funghi_champignon', 'patate_arrosto', 'patate_fritte',
                    'pomodorini', 'pesto', 'rucola', 'basilico'],
                listaFrutta: ['ananas', 'pere'],
                listaLatticini: ['gorgonzola', 'ricotta', 'provola', 'pecorino', 'grana', 'panna', 'bufala'],
